...
# Update channels
bash --login -c ". $HOME/.nix-profile/etc/profile.d/nix.sh && nix-channel --add https://github.com/nix-community/home-manager/archive/release-21.11.tar.gz home-manager && nix-channel --update"
