---
name: summary
description: 'Give the user a fast, ADHD/dyslexia-friendly recap of the current work or conversation — the outcome first, then what (if anything) you need from them. Use when running /summary, or when asked to "summarize", "recap", "where are we", "catch me up", or "what do you need from me".'
argument-hint: '[optional focus, e.g. "just the PR status" or "what is left"]'
---
