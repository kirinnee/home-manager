...
| GPT-5.6-sol @ ultra effort        | best/smartest IMPLEMENTER — less raw smarts than Fable but more diligent and thorough; hand it work once the big ideas, relations, and blindspots are mapped out | slow    | `codex-auto-loge` (default; pinned to ultra reasoning effort)                               |
...
- Standard flow: Fable 5 plans and maps blindspots → sol (or Opus 4.8 / GLM-5.2) implements → terra / GPT-5.5 reviews.
