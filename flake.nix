          ...
          (
            ...
            in
            {
              ...
              value = home-manager.lib.homeManagerConfiguration {
                inherit pkgs;
                modules = [
                  # AI agent accounts are now generated by `kfleet` from
                  # ~/.kfleet/config.yaml, not the multi-{claude,codex,gemini,opencode}
                  # Nix modules. multi-gh/multi-gws remain Nix-managed.
                ...
                modules = [
                  ...
                  }
                  {
                    ...
                    home-manager.sharedModules = [
                      # AI agent accounts now come from `kfleet` (~/.kfleet/config.yaml),
                      # not the multi-{claude,codex,gemini,opencode} Nix modules.
                      home-manager-modules.homeManagerModules.multi-gh
                      home-manager-modules.homeManagerModules.multi-gws
                    ];
                  }
