 ...
 *
 * Full pane is already the persisted/default state, while all three choices are
 * intentionally identical below the readable cap. Showing their proportions
 * beside the radios means selecting a mode on a phone no longer looks like a
 * dead control.
 */
