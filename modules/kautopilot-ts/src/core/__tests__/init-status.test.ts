...
describe('init status and logs', () => {
  ...
  it('materializes init status from init WAL events', () => {
    ...
    appendInitEvent('init-123', { ts: '2026-04-01T10:00:00Z', event: 'init:started', metadata: { pid: 42 } });
    appendInitEvent('init-123', { ts: '2026-04-01T10:00:01Z', event: 'identify:started' });
    appendInitEvent('init-123', {
      ts: '2026-04-01T10:00:02Z',
      event: 'context:updated',
      metadata: { systemName: 'GitHub Issues' },
    });
    appendInitEvent('init-123', { ts: '2026-04-01T10:00:03Z', event: 'identify:completed' });
    appendInitEvent('init-123', { ts: '2026-04-01T10:00:04Z', event: 'research:started' });
  ...
  it('tracks promotion and downgrade outcomes from WAL', () => {
    ...
    appendInitEvent('init-promoted', { ts: '2026-04-01T11:00:00Z', event: 'init:started', metadata: { pid: 7 } });
    ...
    appendInitEvent('init-promoted', { ts: '2026-04-01T11:00:02Z', event: 'init:completed' });
    ...
    appendInitEvent('init-local', { ts: '2026-04-01T12:00:00Z', event: 'init:started', metadata: { pid: 8 } });
    appendInitEvent('init-local', { ts: '2026-04-01T12:00:01Z', event: 'downgrade_local:completed' });
    appendInitEvent('init-local', { ts: '2026-04-01T12:00:02Z', event: 'init:completed' });
  ...
  it('reads init logs from the init root instead of runtime session root', () => {
    ...
    appendInitEvent('init-root-check', { ts: '2026-04-01T13:00:00Z', event: 'identify:started' });
  ...
  it('handles init crash recovery — resets running state without terminal outcome', () => {
    ...
    appendInitEvent('init-crash', { ts: '2026-04-01T14:00:00Z', event: 'init:started', metadata: { pid: 99991 } });
    appendInitEvent('init-crash', { ts: '2026-04-01T14:00:01Z', event: 'identify:started' });
    appendInitEvent('init-crash', { ts: '2026-04-01T14:00:02Z', event: 'identify:completed' });
    appendInitEvent('init-crash', { ts: '2026-04-01T14:00:03Z', event: 'research:started' });
  ...
  it('tracks all init states through complete lifecycle', () => {
    ...
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:00Z', event: 'init:started', metadata: { pid: 100 } });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:01Z', event: 'identify:started' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:02Z', event: 'identify:completed' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:03Z', event: 'research:started' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:04Z', event: 'research:completed' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:05Z', event: 'detect:started' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:06Z', event: 'detect:completed' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:07Z', event: 'gather_context:started' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:08Z', event: 'gather_context:completed' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:09Z', event: 'normalize:started' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:10Z', event: 'normalize:completed' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:11Z', event: 'generate:started' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:12Z', event: 'generate:completed' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:13Z', event: 'verify:started' });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:14Z', event: 'verify:completed' });
    appendInitEvent('init-full', {
      ts: '2026-04-01T16:00:15Z',
      event: 'promote:completed',
      metadata: { outcome: 'promoted', sessionId: 'sess-full' },
    });
    appendInitEvent('init-full', { ts: '2026-04-01T16:00:16Z', event: 'init:completed' });
  ...
  it('tracks failed init outcome', () => {
    ...
    appendInitEvent('init-fail', { ts: '2026-04-01T17:00:00Z', event: 'init:started', metadata: { pid: 200 } });
    appendInitEvent('init-fail', { ts: '2026-04-01T17:00:01Z', event: 'identify:started' });
    appendInitEvent('init-fail', { ts: '2026-04-01T17:00:02Z', event: 'identify:completed' });
  ...
  it('persists repair-loop metadata through context updates', () => {
    ...
    appendInitEvent('init-repair', { ts: '2026-04-01T18:00:00Z', event: 'init:started', metadata: { pid: 300 } });
  ...
  it('persists init status to YAML and supports incremental replay', () => {
    ...
    appendInitEvent('init-yaml', { ts: '2026-04-01T19:00:00Z', event: 'init:started', metadata: { pid: 400 } });
    appendInitEvent('init-yaml', { ts: '2026-04-01T19:00:01Z', event: 'identify:started' });
    ...
    appendInitEvent('init-yaml', { ts: '2026-04-01T19:00:02Z', event: 'identify:completed' });
