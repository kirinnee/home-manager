    ...
    const threads = [
      {
        ...
        body: 'Fix this',
        firstCommentId: 'c2',
        firstCommentDatabaseId: 2,
        replies: [{ id: 'r1', databaseId: 101, author: 'claude', body: 'Fixed', isBot: true }],
        lastReplyByBot: true,
      },
    ];
    ...
    const threads = [
      {
        ...
        body: 'Check this',
        firstCommentId: 'c3',
        firstCommentDatabaseId: 3,
        replies: [{ id: 'r1', databaseId: 102, author: 'claude', body: 'Looking into it', isBot: true }],
        lastReplyByBot: true,
      },
    ];
  ...
  it('handles mixed threads correctly', () => {
    const threads = [
      ...
      },
      {
        ...
        firstCommentId: 'c3',
        firstCommentDatabaseId: 3,
        replies: [{ id: 'r1', databaseId: 103, author: 'claude', body: 'Done', isBot: true }],
        lastReplyByBot: true,
      },
    ];
    const results = preFilterThreads(threads, 'passing');
    ...
    const threads = [
      {
        ...
        firstCommentDatabaseId: 1,
        replies: [
          { id: 'r1', databaseId: 101, author: 'claude', body: 'Done', isBot: true },
          { id: 'r2', databaseId: 102, author: 'human', body: 'Still broken', isBot: false },
        ],
        lastReplyByBot: false,
      },
    ];
